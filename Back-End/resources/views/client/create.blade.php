...
<div class="card-body">
    <form method="POST" action="{{ route('client.store') }}" aria-label="{{ __('Login') }}">
        @csrf
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input id="national_id" type="text" class="form-control{{ $errors->has('national_id') ? ' is-invalid' : '' }}" name="national_id" required>
        ...
        <div class="form-group row">
            <label for="balance" class="col-md-3 col-form-label text-md-right">{{ __('Country') }}</label>
